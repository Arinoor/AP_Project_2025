...
public final class StageSelectionView {
        ...
        public static void show(Stage owner, Consumer<String> onSelected) {
                ...
                RadioButton l5 = new RadioButton("Level 5");
                ...
                RadioButton l7 = new RadioButton("Level 7");
                l7.setUserData("/levels/level7.json");
                l7.setToggleGroup(group);

                VBox box = new VBox(10, l1, l2, l3, l4, l5, l6, l7);
